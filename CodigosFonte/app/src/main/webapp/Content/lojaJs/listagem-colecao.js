window.addEventListener("load", function () {
    var btnNovo = document.querySelector("#btnNovaColecao");
    btnNovo.addEventListener("click", function () {
        window.location = "cadastrar-colecao";
    });
    ...
    for (var i = 0; i < botoesEdicao.length; i++) {
        ...
        btn.addEventListener("click", function () {
            ...
            window.location = "editar-colecao?q=" + id;
        });
    }
    ...
    for (var i = 0; i < botoesExclusao.length; i++) {
        ...
        btn.addEventListener("click", function () {
            ...
            if (confirm("Deseja excluir esta coleção?")) {
                ...
                xhr.open("post", "excluircolecao", true);
